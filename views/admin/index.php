...
<head>
    ...
    <title>AlegarioCure Core 2</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-heading">Dashboard Doctor</li>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Dashboard Doctor</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<body>
  ...
  <!------------------------For Dashboard ------------------>
    ...
    <br><h1>DOCTOR DASHBOARD</h1><br><br>
    &nbsp;&nbsp;<a href="../../environment/session/logout.php" class="button button3">logout</a></button>
    </div>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    alert("Welcome to Doctor Dashboard😉✔");
  });
     </script>
