<?php 
    ...
    include '../../environment/session/medtech.php';
  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-heading">MEDTECH DASHBOARD</li>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">MEDTECH DASHBOARD</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
...
<body>
    ...
    <br><h1>MEDTECH DASHBOARD <img src="../../assets/img/ghgh.png" alt="HR Logo" height="10%" width="20%"></h1>
    &nbsp;&nbsp;&nbsp;<a href="laboratory/update.php" class="btn btn-link bi bi-card-list" style="color: Green; font-size: 20px;"> Update Laboratory</a>
 ...
 <hr>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    alert("Welcome to Medtech Dashboard😉✔");
  });
     </script> -->
