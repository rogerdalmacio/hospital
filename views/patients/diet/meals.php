...
<head>
    ...
    <title>Patient Diet Management</title>
    ...
    width: 800px;  /* Set the width of the module */
    height: 634px;  /* Set the height of the module */
    margin-left: auto;
    margin-right: auto; 
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="diet/meals.php">
            <i class="bi bi-layout-text-window-reverse"></i>
            <span style="color: #2098d1;">Diet</span>
          </a>
        </li>
...
<div>
  <div class="output-box">
    <p>&nbsp; Breakfast</p>
    <p><?php echo $data['breakfast'];?></p>
  </div>
  <div class="output-box">
    <p>&nbsp; Lunch</p>
    <p><?php echo $data['lunch'];?></p>
  </div>
  <div class="output-box">
    <p>&nbsp; Dinner</p>
    <p><?php echo $data['dinner'];?></p>
  </div>
</div>
    ...
    <?php }?>
		   ...
		   <hr>
		<p style="color: grey;">Diet management is about the food and beverages you consume in order to improve or maintain your health and well-being. This includes developing and following a balanced and nutritious diet plan, making healthy food choices, and monitoring food intake in a way that supports optimal health.</p>
