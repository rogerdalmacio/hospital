...
<head>
    ...
    height: 420px;  /* Set the height of the module */
    margin-left: auto;
    margin-right: auto; 
    ...
    <div>
     ...
     <form action="submit_insurance_application.php" method="post">
        ...
        <button type="submit" name="submit" class="button button1">Submit</button>
		   ...
		   <hr>
		<p style="color: grey;">An insurance application is a form or document used by insurance companies to collect information from individuals or organizations who are applying for insurance coverage. </p>
